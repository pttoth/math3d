...
cQuaternion::cQuaternion(float afAngle, const math::float3 & avAxis)
{
...
void cQuaternion::ToRotationMatrix(math::float4x4 &a_mtxDest) const
{
    a_mtxDest = mat4::identity;
...
void cQuaternion::FromRotationMatrix(const math::float4x4 &a_mtxRot)
{
...
void cQuaternion::FromAngleAxis(float afAngle, const math::float3 &avAxis)
{
